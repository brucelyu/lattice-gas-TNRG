...
# initial bound of the critical parameter
zhi = args.zhi
zlo = args.zlo

if scheme == "trg":
    tnrg_pars = {"chi": chi, "dtol": cgeps, "display": False}
elif scheme == "efrg":
    tnrg_pars = {"chi": chi, "dtol": cgeps, "display": False,
